namespace Ex03.GarageLogic
{
    ...
    public abstract class Truck : Vehicle
    {
        ...
        public static Dictionary<string, Type> s_TruckleInformation = new Dictionary<string, Type>() { { string.Format(@"Press yes/no if the truck drives refrigerated stuff."), typeof(bool) }, { string.Format(@"Enter cargo volume (in Cubic meter): "), typeof(float) } };
